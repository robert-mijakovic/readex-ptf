...
enum tPlugin {
    UNKOWN_PLUGIN, CFS, CFSCL, MPI, MPICAP, PCAP, Pipeline, Power, TUTCOMBINESCEN, TUTGENSRCH, TUTMULTIOBJ, TUTMULTIRANK, TUTMULTITUNE, TUTOBJFUNC, TUTREGIONS, TUTSCALABILITYBASIC, TUTSCENANALYSIS, TUTTPCROSS, TUTVECTORRANGE
};
